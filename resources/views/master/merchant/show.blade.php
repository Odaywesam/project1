                ...
                <div class="card card-primary">
                    ...
                    <form id="create_form">
                        ...
                        <div class="card-footer">
                            {{-- <button type="button" onclick="update({{$s->id}})" class="btn btn-lg btn-success">تعديل</button> --}}
                            <a href="{{route('merchants.index')}}"><button type="button" class="btn btn-lg btn-primary">
...
$('.city_id').select2({
    ...
    function update(id){
        ...
        let formData = new FormData();
            ...
            storeRoute('/cms/admin/update_s/'+id , formData );
