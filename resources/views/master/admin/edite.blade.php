                      ...
                      <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" name="first_name" class="form-control" id="first_name"
                                    value="{{ $admins->first_name}}" placeholder=" Enter  name ">
                            </div>

                            <div class="form-group col-md-4">
                                <label for="last_name">  last name</label>
                                <input type="text" name="last_name" class="form-control" id="last_name"
                                value="{{ $admins->last_name}}" placeholder="enter Street name">
                            </div>
...
{{--
                            ...
                            <div class="form-group col-md-4">
                             ...
                             <div class="form-group col-md-6">
                                ...
                                value="{{ $admins->image}}}"   placeholder="  enter image">
                            </div>

                            <div class="form-group col-md-6">
                                <label for="cv"> cv</label>
                                <input type="file" name="cv" class="form-control" id="cv"
                                value="{{ $admins->cv}}}"  placeholder="enter your cv">
                            </div>
