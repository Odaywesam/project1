...
class RolePermissionController extends Controller
{
    ...
    public function index($roleId)
    {
        ...
        return response()->view('master.spaite.roles.role-permission', ['roleId' => $roleId, 'permissions' => $permissions]);
    }
    ...
    public function store(Request $request, $roleId)
    {
        ...
        if (!$validator->fails()) {
            ...
            if ($role->hasPermissionTo($permission->id)) {
                ...
                return response()->json(['icon' => ' success' , 'title' => 'successfully'] , 200);
